...
parser.add_argument("-encoder", type = str, help = "select encoder", default = "bert", choices = ["lstm", "gru", "mlp", "cnn", "bert"])
...
if args["encoder"] == "bert":
    data = dataholder_bert(data_dir, dataset, 64, args["bert_model"])
else:    
    data = dataholder(data_dir, dataset, 64)
...
epochs = 20 if args["encoder"] != "bert" else 100
